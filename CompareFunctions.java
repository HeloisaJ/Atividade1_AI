public class CompareFunctions {
    ...
    public void executeComparison(State s){
        ...
        res = (endTime - startTime); // Calcula o tempo de execução do env1
        ...
        res2 = (endTime2 - startTime2); // Calcula o tempo de execução do env1
        ...
        int x = 1;
        if(res2 < res){ // Vê qual dos dois teve o menor tempo
            x = 2;
        }
    ...
    private void executeEnv(State s, Environment e){ 
        Node n = e.executeAlgorithm(s); // Executa um algoritmo
        revealLastState(n);
    }

    private void revealLastState(Node n){ // Mostra o estado final e a profundidade desse nó 
